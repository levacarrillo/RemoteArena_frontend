...
import './AdminAssignmentFiles.css';

export const AdminAssignmentFiles = () => {
    ...
    return (
        <div className="admin-assignment-files">
            <Title level={2}>Assignment files administrator</Title>
            <Flex>
